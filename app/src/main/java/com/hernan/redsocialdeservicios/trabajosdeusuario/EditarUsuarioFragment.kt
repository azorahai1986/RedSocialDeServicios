...
import com.hernan.redsocialdeservicios.databinding.FragmentEditarUsuarioBinding
...
class EditarUsuarioFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditarUsuarioBinding.inflate(layoutInflater, container, false)
